...
const makePartialRepresentation = ({id, name, title, avatarUrl, bio, availability, profession, location}) => ({
  id, name, title, avatarUrl, bio, availability, profession, location
});
